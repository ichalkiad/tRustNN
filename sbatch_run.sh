...
#execute application
python /home/icha/tRustNN/src/dynamic_lstm_TF.py with 'seed=27105828'  'db="file"' 'run_id="lstm_embedding_FINALTEST_3"'  'n_epoch=5' 'net_arch_layers = ["lstm","fc","output"]' 'net_arch.lstm.return_state=True' 'net_arch.lstm.return_seq=True'  'batch_size = 32' 'save_path = "/home/icha/sacred_models/"' 'tensorboard_dir = "/home/icha/sacred_models/tf_logs/"' 'embedding_dim = 100' 'internals = "all"' 'save_mode="pickle"' 'test_size=20' 'net_arch.lstm.n_units=100' 'n_words=10000' 'embedding_layer=1' 'max_len=100'
